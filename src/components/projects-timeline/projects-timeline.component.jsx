...
// projects
import L_ReactToDoList from "../../assets/img/projects/udyanshSociety.JPG";
import L_MernTipCalc from "../../assets/img/projects/RegistrationForm.JPG";
...
const TimeLine = () => {
  return (
    <div id="projects">
      <h1 className="pt-3 text-center font-details-b projects-heading pb-3">PROJECTS</h1>
      <Timeline className="p-0 m-0">
        <Events>
        {/* Project: Udyansh Website */}
        <ImageEvent
            date="10/07/2020"
            className="text-center"
            text="Udyansh Society's Website"
            src={L_ReactToDoList}
            alt="Udyansh Society's Website"
          >
                ...
                <Accordion >
                  <Card>
                    ...
                    <Accordion.Collapse eventKey="0" className="text-left">
                      <Card.Body>
                        <strong>Description:</strong> This project includes the UI/UX Website design of an NGO who works in the field of Education. A static website is made with the help of Programming Languages.
                        <hr />
                        <strong>Features:</strong>
                        <ul className="list-styles pt-1">
                          <li>Shows Information about organisation</li>
                          <li>Powered by React and Styled CSS</li>
              ...
              <div>
                <Accordion>
                  <Card>
                    ...
                    <Accordion.Collapse eventKey="0" className="text-left">
                      <Card.Body>
                        <strong>Description:</strong> This project includes the UI/UX Website design of a Registration Form. A dynamic form is made with the help of programming languages and then the data is saved in the database.
                        <hr />
                        <strong>Features:</strong>
                        <ul className="list-styles pt-1">
                          <li>Registration form with Validations</li>
