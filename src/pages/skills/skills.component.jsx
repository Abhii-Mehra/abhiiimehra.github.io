...
const Skills = () => {
  return (
    <div className="" id="skills">
      <h1 className="text-center font-details-b tech-skill-heading">TECH SKILLS</h1>
      <CardDeck>
        <Row className="d-flex justify-content-around">
          <Col md={4} className="p-0 m-0">
            <Card className="focus">
              <Card.Body>
                <Card.Title className="text-center card-title">Mechanical Softwares</Card.Title>
                <hr />
                <Card.Text className="card-text d-flex justify-content-start flex-column">
                  {skills.mechanicalsoftwares.map((skill, index) => (
