...
const ContactForm = () => {
  return (
    <div id="contact">
      <h1 className="text-center font-details-b contact-me-heading">CONTACT ME</h1>
      <Jumbotron className="contact-jumbotron m-0 p-0">
        <Row>
          <Col className="d-flex justify-content-center flex-wrap m-0 p-0">
            <div className="m-2">
              <a href="mailto:abhii20mehra@gmail.com" target="_blank" rel="noopener noreferrer">
                <Button variant="outline-danger" title="abhii20mehra@gmail.com">
            ...
            <div className="m-2">
              <a href="https://www.instagram.com/_abhishek.mehra_/" target="_blank" rel="noopener noreferrer">
                <Button variant="outline-dark" title="My other projects">
                  <i className="fab fa-github-square"></i> Instagram
                </Button>
              </a>
            </div>
            {/* <div className="m-2">
